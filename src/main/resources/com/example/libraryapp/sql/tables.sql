...
INSERT INTO `books` (`title`, `picture`, `author`, `genre`, `edition`, `isbn`, `rating`, `language`, `isDeleted`, `copyAmount`, `datePub`) VALUES
('Harry Potter', '/com/example/libraryapp/assets/book3.jpg', 'J.K.R', 'Fiction,Crime,Psychological', 'eveniet', '123269512', '5.00', 'mi', 1, 5, '2009'),
('Et blanditiis placeat cupiditate pariatur natus consectetur.', '/com/example/libraryapp/assets/book4.jpg', 'dr Nico', 'Fiction,Crime,Psychological', 'dolorem', '123269512', '5.00', 'gd', 0, 5, '2010'),
('Beatae voluptatem possimus rerum est quos ut.', '/com/example/libraryapp/assets/book3.jpg', 'Billy Lebsack', 'Fiction,Crime,Psychological', 'at', '123269512', '5.00', 'ch', 1, 5, '2011'),
('Perspiciatis culpa natus dolores.', '/com/example/libraryapp/assets/book1.jpg', 'Orland Dach', 'Fiction,Crime,Psychological', 'dignissimos', '123269512', '5.00', 'or', 1, 5, '2002'),
('Enim non consequatur soluta dolor tempore consequatur nostrum.', '/com/example/libraryapp/assets/book4.jpg', 'Miss Abby Cartwright', 'Fiction,Crime,Psychological', 'qui', '123269512', '5.00', 'jv', 0, 5, '2022');
...
INSERT INTO `students` (`username`, `picture`, `email`, `password`, `cin`, `description`, `privileges`, `maxBorrowed`, `flagged`, `timestamp`) VALUES
('kirlin.laurence', '/com/example/libraryapp/assets/profile.png', 'hilda@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'EE15469', 'Dolores dignissimos in ut laborum officiis repudiandae. Saepe fugit dolor eius eum voluptatem commodi minima. Delectus veritatis rerum qui dolor. Velit et est cumque repellat quos reprehenderit numquam. Sed ullam sed libero ea voluptatem velit eaque.', 1, 3, 0, '2022-12-11 15:54:17'),
('adriana48', '/com/example/libraryapp/assets/profile.png', 'charlotte.farrell@hotmail.com', 'OiHA0/gGE+dRSv@', 'EE15469', 'Unde dolore blanditiis vero vel velit est ea aperiam. Et dolor commodi et fugit nemo iste deserunt. Numquam quae minima in quo hic. Natus quis minus est.', 1, 3, 0, '2022-10-26 13:49:37'),
('kbogan', '/com/example/libraryapp/assets/profile.png', 'brooks78@purdy.net', 'QG_KSBf_Z,', 'EE15469', 'Temporibus et dolor natus quasi sed. Voluptas nemo non hic deleniti quasi dolorum modi. Perspiciatis nulla fugiat consectetur laboriosam occaecati. Voluptas et aut dolor inventore.', 1, 3, 0, '2022-10-26 13:49:37'),
('edyth.frami', '/com/example/libraryapp/assets/profile.png', 'jacynthe39@franecki.com', 'f-<jJJI=LO?.]?8(uf', 'EE15469', 'Magni et sequi doloribus qui alias at maxime. Nobis vero aut aut ipsa. Nemo rerum molestias distinctio. Minus libero magni tenetur et quasi. Sequi qui cupiditate quia tempore. Tempora amet tenetur dolores dolores voluptatem.', 1, 3, 0, '2022-10-26 13:49:37'),
('arvid19', '/com/example/libraryapp/assets/profile.png', 'hermiston.hilda@yahoo.com', 'N3CniC@}`DN:{Fw6', 'EE15469', 'Optio ullam id itaque. Atque mollitia molestiae velit omnis ullam error vero. Dolore doloremque est sed laboriosam pariatur quis. Quia eos omnis dolores aut. Nobis cumque dolores maxime quae unde ullam ea deleniti.', 1, 3, 0, '2022-10-26 13:49:37');
...
(1, 1, 1, '2022-11-01 14:17:53', NULL),
(2, 2, 1, 'June 1 2022', NULL),
(3, 3, 1, 'June 1 2022', NULL);
...
('boss', 'https://via.placeholder.com/640x480.png/003311?text=mollitia', 'superadmin@email.com', '12az55sd', 'EE789654', 'Delectus qui qui porro sed animi sapiente sit. Voluptas veritatis odit hic totam quis. Eaque ea qui voluptate est molestias.', 3, NULL, NULL, '2022-10-26 13:49:37');
