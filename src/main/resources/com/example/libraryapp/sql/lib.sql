...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 11 déc. 2022 à 12:43
...
(2, 'Et blanditiis placeat cupiditate pariatur natus consectetur.', '/com/example/libraryapp/assets/book4.jpg', '/com/example/libraryapp/assets/book4.jpg', 'Fiction,Crime,Psychological', 'dolorem', '123269512', '5.00', 'gd', 0, 5, '2010'),
...
(4, 'Perspiciatis culpa natus dolores.', '/com/example/libraryapp/assets/book4.jpg', 'Orland Dach', 'Fiction,Crime,Psychological', 'dignissimos', '123269512', '5.00', 'or', 1, 5, '2002'),
...
(1, 'kirlin.laurence', '/com/example/libraryapp/assets/profile.png', 'romaguera.maritza@russel.com', '!EMo79:|2g*8h}', 'EE15469', 'Dolores dignissimos in ut laborum officiis repudiandae. Saepe fugit dolor eius eum voluptatem commodi minima. Delectus veritatis rerum qui dolor. Velit et est cumque repellat quos reprehenderit numquam. Sed ullam sed libero ea voluptatem velit eaque.', 1, 3, 0, '2022-12-11 11:41:04'),
(2, 'adriana48', '/com/example/libraryapp/assets/profile.png', 'charlotte.farrell@hotmail.com', 'OiHA0/gGE+dRSv@', 'EE15469', 'Unde dolore blanditiis vero vel velit est ea aperiam. Et dolor commodi et fugit nemo iste deserunt. Numquam quae minima in quo hic. Natus quis minus est.', 1, 3, 0, '2022-12-11 11:41:12'),
(3, 'kbogan', '/com/example/libraryapp/assets/profile.png', 'brooks78@purdy.net', 'QG_KSBf_Z,', 'EE15469', 'Temporibus et dolor natus quasi sed. Voluptas nemo non hic deleniti quasi dolorum modi. Perspiciatis nulla fugiat consectetur laboriosam occaecati. Voluptas et aut dolor inventore.', 1, 3, 0, '2022-12-11 11:41:15'),
(4, 'edyth.frami', '/com/example/libraryapp/assets/profile.png', 'jacynthe39@franecki.com', 'f-<jJJI=LO?.]?8(uf', 'EE15469', 'Magni et sequi doloribus qui alias at maxime. Nobis vero aut aut ipsa. Nemo rerum molestias distinctio. Minus libero magni tenetur et quasi. Sequi qui cupiditate quia tempore. Tempora amet tenetur dolores dolores voluptatem.', 1, 3, 0, '2022-12-11 11:41:18'),
(5, 'arvid19', '/com/example/libraryapp/assets/profile.png', 'hermiston.hilda@yahoo.com', 'N3CniC@}`DN:{Fw6', 'EE15469', 'Optio ullam id itaque. Atque mollitia molestiae velit omnis ullam error vero. Dolore doloremque est sed laboriosam pariatur quis. Quia eos omnis dolores aut. Nobis cumque dolores maxime quae unde ullam ea deleniti.', 1, 3, 0, '2022-12-11 11:41:20');
